...
import { mentorGlassCardFrost, mentorPrimaryCta } from "@/app/Components/mentor/mentor-theme";

type VoiceNotesEmptyStateProps = {
  onUpload: () => void;
};

export default function VoiceNotesEmptyState({ onUpload }: VoiceNotesEmptyStateProps) {
  return (
    <div
    ...
    >
      ...
      <p className="mt-3 max-w-sm text-sm leading-relaxed text-white/65">
        Upload audio conversations to generate:
      </p>
      ...
      <button
        type="button"
        onClick={onUpload}
        className={`${mentorPrimaryCta} mt-8 min-h-[44px] px-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#3498DB]`}
      >
