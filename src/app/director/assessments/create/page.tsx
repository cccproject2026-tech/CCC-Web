...
export default function CreateAssessmentPage() {
  ...
  return (
    <div className={directorPageRoot}>
      <div className="mx-auto w-full max-w-[900px] px-4 pb-12 sm:px-8">
        <div className={`mb-8 p-6 sm:p-8 ${directorGlassCard}`}>
          <h2 className="text-xl font-semibold text-white sm:text-2xl">Create – Assessment</h2>
        </div>

        <div className={`space-y-6 p-6 sm:p-8 ${directorGlassCard}`}>
          {/* Name of Assessment */}
          <div>
          ...
          <div>
            ...
            {sections.map((section, sectionIdx) => (
              <div
                key={section.id}
                className={`mb-4 space-y-4 p-6 ${directorGlassCard}`}
              >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className={`${directorBtnSecondary} !px-3`}
                    >
                    ...
                    <input
                      ...
                      className={`${directorInputClass} w-20 text-center`}
                    />
                    <button
                      type="button"
                      onClick={() =>
                    ...
                    {layer.choices.map((choice, choiceIdx) => (
                      <div key={choiceIdx} className="mb-2 flex gap-2">
                        <input
                          ...
                          className={`${directorInputClass} flex-1`}
                        />
                        <button
                          type="button"
                          onClick={() =>
          ...
          <div>
            ...
            <label className="relative block cursor-pointer">
              <input
                ...
                className="hidden"
              />
              <div className={`rounded-lg border-2 border-dashed border-white/25 p-8 text-center transition hover:border-[#8ec5eb]/50 sm:p-12 ${directorGlassCard}`}>
                {bannerPreview ? (
