...
export default function ThreeYearStrategicPlan() {
  const [activeTab, setActiveTab] = useState("overview");
  const [reviewDate, setReviewDate] = useState("");
  const [notes, setNotes] = useState("");

  const handleSubmit = () => {
    console.log("3-Year Strategic Plan submitted");
  };
    ...
    <div className="min-h-screen flex flex-col bg-[#0F4A85]">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl font-semibold mb-1">3–Year Strategic Plan</h1>
