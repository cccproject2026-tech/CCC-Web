    ...
    <div className="min-h-screen flex flex-col bg-[#0F4A85] text-white">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl font-semibold leading-snug mb-1">Prayer</h1>
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Prioritize church prayer opportunities and meet consistently
                    for prayer with your congregation
                  </div>
                </div>
