...
import PastorHeader from "@/app/Components/PastorHeader";import HeroBg from "../../Assets/jumpstart-hero.png"; // 🖼 Replace with actual hero image
import "@fortawesome/fontawesome-free/css/all.min.css";

export default function RevitalizationPlan() {
    ...
    <div className="min-h-screen flex flex-col bg-[#0F4A85]">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl font-semibold mb-1">Revitalization Plan</h1>
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Share and celebrate your revitalization plan wins with your congregation
                  </div>
                </div>

                {/* CELEBRATION DATE */}
                <div className="mb-10 w-full sm:w-[300px]">
                  <label className="block text-sm mb-1">Celebration Date</label>
