              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Coordinate preaching calendar for the year
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Coordinate a preaching calendar for the year that focuses on
                    a growing relationship with Christ and with each ministry
                    leader
                  </div>
                </div>

                {/* ---------- Upload Preaching Calendar ---------- */}
                <div className="mb-10">
