...
export default function FinalRevitalizationReview() {
  const [activeTab, setActiveTab] = useState("overview");
  const [praiseDate, setPraiseDate] = useState("");
  ...
  const handleSubmit = () => {
    console.log("Final Review submitted");
  };
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Conduct a final review session to help the congregation
                    celebrate wins and identify next steps of growth.
                  </div>
                </div>

                {/* PRAISE & THANKSGIVING DATE */}
                <div className="mb-8 w-full sm:w-[300px]">
                  <label className="block text-sm mb-1">
                    Praise and Thanksgiving Date
                  </label>
                  <div className="relative">
                    ...
                    <input
                      type="date"
                      value={praiseDate}
                      onChange={(e) => setPraiseDate(e.target.value)}
                ...
                <div className="mb-10">
                  ...
                  {uploadedFile && (
                    <p className="text-sm mt-2 text-white/80 italic">
