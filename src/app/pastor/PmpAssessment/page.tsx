...
import PastorHeader from "@/app/Components/PastorHeader";import HeroBg from "../../Assets/jumpstart-hero.png"; // 🖼 Replace with the correct hero image
import "@fortawesome/fontawesome-free/css/all.min.css";

export default function PmpAssessment() {
  const [activeTab, setActiveTab] = useState("overview");
  const [reviewDate, setReviewDate] = useState("2024-11-07");

  const handleSubmit = () => {
    console.log("Retake PMP Assessment Survey clicked");
  };
    ...
    <div className="min-h-screen flex flex-col bg-[#0F4A85]">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl font-semibold mb-1">PMP Assessment</h1>
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Review the first PMP assessment survey taken and repeat
                    survey for revitalization results.
                  </div>
                </div>
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="bg-transparent border border-[#A6B8E8] hover:bg-[#103C8C] hover:text-white transition text-[#E8ECFF] text-sm font-medium px-8 py-[8px] rounded-md shadow-sm"
                  >
                    Retake PMP Assessment Survey
                  </button>
                </div>
              </>
            )}
