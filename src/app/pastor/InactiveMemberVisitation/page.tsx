...
export default function InactiveMemberVisitation() {
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm bg-transparent text-white/90">
                    Train church leadership in visitation
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Model and train church leadership in inactive member pastoral
                    visitation.
                  </div>
                </div>
                ...
                <div className="mb-10 w-full sm:w-[300px]">
                  <label className="block text-sm mb-1">Training Date</label>
