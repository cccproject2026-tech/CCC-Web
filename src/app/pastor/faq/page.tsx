...
export default function PastorFaqPage() {
  ...
  return (
    <main className="relative z-10 mx-auto flex w-full max-w-5xl flex-1 flex-col px-4 py-8 sm:px-6 lg:px-8">
      <section className="rounded-3xl border border-white/15 bg-[linear-gradient(180deg,rgba(12,58,95,0.92)_0%,rgba(10,53,88,0.97)_100%)] px-5 py-6 shadow-[0_20px_45px_rgba(2,20,38,0.35)] sm:px-6 sm:py-8">
