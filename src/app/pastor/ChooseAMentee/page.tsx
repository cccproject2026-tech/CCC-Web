...
export default function ChooseAMentee() {
  const [activeTab, setActiveTab] = useState("overview");
  const [menteeName, setMenteeName] = useState("");

  const handleSubmit = () => {
    console.log("Submitted mentee name:", menteeName);
  };
    ...
    <div className="min-h-screen flex flex-col bg-[#0F4A85]">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl font-semibold mb-1">Choose a Mentee</h1>
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Choose a colleague to be your mentee to share Christ’s Method
                    Alone Revitalization program.
                  </div>
                </div>

                {/* NAME OF MENTEE */}
                <div className="mb-10 w-full sm:w-[850px]">
                  <label className="block text-sm mb-1">Name of Mentee</label>
                  <input
                    type="text"
                    value={menteeName}
                    onChange={(e) => setMenteeName(e.target.value)}
                    placeholder="Enter name of mentee..."
