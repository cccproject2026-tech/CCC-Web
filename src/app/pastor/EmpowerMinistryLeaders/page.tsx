...
export default function EmpowerMinistryLeadersPage() {
    ...
    <div className="min-h-screen flex flex-col bg-[#0F4A85] text-white relative">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-sm">Completion Time Months 7 – 9</p>
        </div>
      </section>
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm bg-transparent text-white/90">
                    Empower ministry leaders and new members into calendar
                    events
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Begin empowering ministry leaders into calendar activities
                    in the worship service and offering a regular new member
                    opportunity to come to the church service. Including lay
                    Bible “worker” roles.
                  </div>
                </div>
