...
export default function ProclamationResources() {
  const [activeTab, setActiveTab] = useState("overview");
  const [notes, setNotes] = useState("");

  const handleSubmit = () => {
    console.log("Proclamation Resources submitted");
  };
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm bg-transparent text-white/90">
                    Implement Proclamation Resources
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Proclamation Resources available through{" "}
                    <a
                      href="https://www.nadei.org"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="underline text-[#FFFFFF] hover:text-white transition"
                    >
                      NADEI.org
                    </a>
                  </div>
                ...
                <div className="mb-10 w-full">
                  ...
                  <textarea
                    ...
                    className="w-full bg-transparent border border-[#5A8DCB] rounded-md px-3 py-2 text-sm text-white focus:outline-none resize-none"
                  />
                </div>
