      ...
      <main className="flex-1 bg-transparent px-4 py-12 md:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
          {!hasApplied ? (
            ...
            //       <div>
            //         <h2 className="text-2xl font-bold text-[#1d538d]">
            ...
            //   <div className="mt-6 rounded-2xl bg-white p-6 text-black shadow-lg">
            //     <h3 className="mb-5 text-xl font-bold text-[#1d538d]">Submitted Answers</h3>
            ...
            //           <p className="mt-2 text-sm text-gray-600">{String(value || "—")}</p>
            //         </div>
            //       ))}
            //     </div>
            //   </div>
            ...
            //   <div className="mt-6 rounded-2xl bg-white p-6 text-black shadow-lg">
            //     <h3 className="mb-5 text-xl font-bold text-[#1d538d]">Supporting Documents</h3>
            ...
            //               target="_blank"
            //               rel="noreferrer"
            //               className="text-sm font-semibold text-[#1d538d]"
            //             >
            //               Open
            //             </a>
            //           </div>
