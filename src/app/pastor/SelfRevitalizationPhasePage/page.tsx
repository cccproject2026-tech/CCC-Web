...
import HeroBg from "@/app/Assets/self-revitalization-hero.png"; // replace with correct image
      ...
      >
        ...
        <div className="relative z-10">
          <p className="text-xs text-white/80 mb-2">
            ...
            <span className="text-white font-medium">Self Revitalization Phase</span>
          </p>
          <div className="flex items-center gap-2">
            <span className="bg-[#FFD84E] text-[#0B1C58] text-xs font-semibold px-3 py-[3px] rounded-md">
              Phase 1
            </span>
            <h1 className="text-3xl font-semibold">Self Revitalization Phase</h1>
          </div>
        </div>
      </section>
    ...
    <div className="flex bg-white rounded-lg shadow-sm overflow-hidden p-1">
      {["All", "Due", "Not Started", "Completed"].map((tab) => (
        ...
        >
          ...
          {tab === "Due" && (
            <span
              className="absolute top-2 -right-1 bg-[#FFD84E] text-[#0B1C58] text-[10px] font-bold rounded-full w-5 h-5 flex items-center justify-center border border-white"
            >
              3
            </span>
          )}
