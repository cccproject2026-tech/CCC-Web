...
export default function MentoringConversationsPage() {
  ...
  const [month4Date, setMonth4Date] = useState("");
  const [isCompleted, setIsCompleted] = useState(false);

  const handleComplete = () => {
    if (month3Date && month4Date) {
      setIsCompleted(true);
    } else {
      alert("Please select both meeting dates before marking as complete.");
    }
  };
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Schedule a mentoring conversation for both month’s 3 and 4
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="date"
                        value={month3Date}
                        onChange={(e) => setMonth3Date(e.target.value)}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="date"
                        value={month4Date}
                        onChange={(e) => setMonth4Date(e.target.value)}
                        className="w-full bg-transparent border border-[#5A8DCB] rounded-md p-3 pl-9 text-sm text-white/80 focus:outline-none placeholder:text-white/50"
                      />
                    </div>
                  </div>
