...
export default function SecretGuestPage() {
  ...
  const handleComplete = () => {
    if (visitDate) {
      ...
      alert("Please select the Secret Guest visit date before completing.");
    }
  };
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm bg-transparent text-white/90">
                    Schedule a secret guest visit and process results
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Process the “secret guest” visit with your church and
                    incorporate findings into your welcome team strategy
                  </div>
                </div>
                ...
                <div className="mb-10">
                  <h3 className="text-sm font-semibold mb-2">
                    Secret Guest visit date
                  </h3>
                  <div className="relative w-full max-w-sm">
                    <i className="fa-regular fa-calendar absolute left-3 top-3 text-white/70 text-sm"></i>
                    <input
                      type="date"
                      value={visitDate}
                      onChange={(e) => setVisitDate(e.target.value)}
                      className="w-full bg-transparent border border-[#5A8DCB] rounded-md p-3 pl-9 text-sm text-white/80 focus:outline-none placeholder:text-white/50"
                    />
                  </div>
                </div>
