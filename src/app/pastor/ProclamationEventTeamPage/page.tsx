...
export default function ProclamationEventTeamPage() {
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Recruit Proclamation Event Team
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="border border-[#5A8DCB] rounded-md p-3 text-sm text-white/90 bg-transparent">
                    Recruit a team in charge of a proclamation event that shares
                    the Christian gospel with various audiences by creating a
                    welcoming environment to explore the community and connect
                    their faith
                  </div>
                </div>
